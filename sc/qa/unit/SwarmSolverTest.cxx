...
class SwarmSolverTest : public UnoApiTest
{
    ...
    void testInfeasibleConstraints_Differential_Evolution();
    void testInfeasibleConstraints_Particle_Swarm();
    void testLargeObjectiveStillSolvable_Differential_Evolution();
    void testLargeObjectiveStillSolvable_Particle_Swarm();
...
public:
    ...
    CPPUNIT_TEST(testInfeasibleConstraints_Differential_Evolution);
    CPPUNIT_TEST(testInfeasibleConstraints_Particle_Swarm);
    CPPUNIT_TEST(testLargeObjectiveStillSolvable_Differential_Evolution);
    CPPUNIT_TEST(testLargeObjectiveStillSolvable_Particle_Swarm);
...
void SwarmSolverTest::testInfeasibleConstraints_Differential_Evolution()
{
    // Regression: the solver used to report success even when no point satisfies
    // the model.

    // Differential Evolution returns no candidate at all
...
void SwarmSolverTest::testInfeasibleConstraints_Particle_Swarm()
{
    // Regression: the solver used to report success even when no point satisfies
    // the model.

    // Particle Swarm Optimization returns its starting point.
    // result is infeasible and getSuccess must be false.
    loadFromFile(u"Simple.ods");
...
void SwarmSolverTest::testLargeObjectiveStillSolvable_Differential_Evolution()
{
...
void SwarmSolverTest::testLargeObjectiveStillSolvable_Particle_Swarm()
{
    // Regression: a feasible objective below the float range used to lose to the
    // infeasible penalty, so the search gave up on a solvable model. The Particle
    // Swarm result also used to grow past the variable count, which the length
